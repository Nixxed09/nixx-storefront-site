...
export const products: Product[] = [
  ...
  {
    id: "solo-disc-dasher",
    name: "Solo Disc Dasher",
    category: "figures",
    description:
      "Clean solo shot of the orange disc hero, perfect for a single-character display or story card.",
    price: 29.99,
    status: "single hero",
    color: "#f15a24",
    ...
    ageNote: "Ages 6+",
    funnel: "starter",
    characterClass: "Catcher",
    motto: "Eyes up. Hands ready.",
    origin:
      "A focused version of Disc Dasher shown alone, training the exact moment before a legendary catch.",
    gear: ["flying disc", "orange gloves", "training pose"],
    lesson: "Great plays start before the ball or disc arrives.",
  },
  {
    id: "skate-spark",
    name: "Skate Spark",
